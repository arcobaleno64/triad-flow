...
2. **Loop Engineering (控制閉環)**:
   - Closed-loop OODA self-healing: Master Driver (Claude) ➔ Macro Sentry (Gemini) ➔ Micro Arbiter (OpenAI/Codex) ➔ Auto-remediation patch ➔ Green gate exit.
...
- **Zero Schema Bureaucracy**: Do NOT create manual Markdown schemas or rigid state machines. Trust Git commits, tests, and SARIF output.
